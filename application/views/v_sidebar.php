      ...
      <div class="sidebar-wrapper">
        <ul class="nav" id="nav">
          ...
          <li class="nav-item ">
            <a class="nav-link" data-toggle="collapse" href="#appointment">
              <span class="sidebar-mini"><i class="material-icons">content_paste</i> <span class="sidebar-mini"></span>
              <span class="sidebar-normal"></span><p> Appointment
                <b class="caret"></b>
              </p>
              </span>
            </a>
          ...
          <li class="nav-item ">
            <a class="nav-link" data-toggle="collapse" href="#controlCenter">
              <span class="sidebar-mini"> <i class="material-icons">settings</i> </span>
              <span class="sidebar-normal"><p> Control Center
                <b class="caret"></b>
              </p>
              </span>
            </a>
          ...
          <li class="nav-item active-pro " id="nav">
