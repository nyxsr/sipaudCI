...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Buat Tenaga Pendidik Baru </h4>
</div>
                        ...
                        <form method="POST" id="addForm" action="javascript:void(0);">                       
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group" id="inputan_nuptk">
                                        <label class="bmd-label-floating">NUPTK (Nomor Unit Pendidik dan Ketenaga Pendidikan)</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group" id="inputan_nip">
                                        <label class="bmd-label-floating">NIP (Nomor Induk Pegawai)</label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" required name="no_telp" id="no_telp" class="form-control">
                                    </div>
                                </div>
                            </div>     
                            <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="diklatdasar">
                                    <label class="custom-control-label" for="diklatdasar">Diklat Tingkat Dasar</label>
                                    <input type="text" style="display:none" name="tahundiklatdasar" placeholder="Tahun Diklat Dasar" id="tahundiklatdasar" class="form-control" onblur="$('#tahundiklatdasar').addClass('is-focused')" > 
                                </div>

                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="diklatlanjut">
                                    <label class="custom-control-label" for="diklatlanjut">Diklat Tingkat Lanjut</label>
                                    <input type="text" style="display:none" name="tahundiklatlanjut" placeholder="Tahun Diklat Lanjut" id="tahundiklatlanjut" class="form-control" onblur="$('#tahundiklatlanjut').addClass('is-focused')" > 
                                </div>

                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="diklatmahir">
                                    <label class="custom-control-label" for="diklatmahir">Diklat Tingkat Mahir</label>
                                    <input type="text" style="display:none" name="tahundiklatmahir" placeholder="Tahun Diklat Mahir" id="tahundiklatmahir" class="form-control" onblur="$('#tahundiklatmahir').addClass('is-focused')" > 
                                </div>
                            </div>
...
$('[name="nip"]').on('input', function() {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url() ?>kelola_tenagaPendidik/cek_nip",
        dataType: "json",
        data: {
            nip: nip
        },
...
$('[name="nuptk"]').on('input', function() {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url() ?>kelola_tenagaPendidik/cek_nuptk",
        dataType: "json",
        data: {
            nuptk: nuptk
        },
...
$('[name="btn_simpan"]').on('click', function() {
    ...
    if (
        ...
        if ($('#inputan_nuptk').hasClass("has-success")) {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>kelola_tenagaPendidik/add",
                dataType: "json",
                data: {
                    nuptk,
                    nip,
