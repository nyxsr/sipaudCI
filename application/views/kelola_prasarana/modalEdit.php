...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Ubah Prasarana</h4>
</div>
        ...
        <form method="POST" id="addForm" action="javascript:void(0);">
            <div class="row" style="padding-bottom: 0px;">
                <div class="list col-md-12 dropdown bootstrap-select dropdown" style="width=100% !important;">
                    <label for="nama_lembaga" style="font-size:.6875rem;margin-bottom:0px;" class="bmd-label-static">Nama
                        Lembaga</label>
                    <select name="nama_lembaga" class="selectpicker" data-style="select-with-transition" title="Pilih Lembaga"
                        data-size="7" tabindex="-98" <?=($this->session->userdata('role') == "operator") ? "disabled" : "" ?>>
                        <?php 
                        foreach ($dataLembaga as $index => $d) :
                                                ?>
                        <option value="<?= $d['id'] ?>" <?=($d['id']==$data['id_lembaga']) ? "selected" : "" ?>>
                            <?= $d['nama_lembaga']?>
                        </option>
                        <?php
                        endforeach;
            ...
            <div class="row">
                <div class="col-md-12">
                    <h6>Ruang Kepala Sekolah</h6>
                    <div style="margin-top:6px;">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="Tersedia_Kepsek"
                                name="Ruang_Kepala_Sekolah" value="Tersedia"
                                <?=($data['Ruang_Kepala_Sekolah']=="Tersedia" ) ? "checked" : "" ?>>
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="Tidak_Tersedia_Kepsek"
                                ...
                                <?=($data['Ruang_Kepala_Sekolah']=="Tidak Tersedia" ) ? "checked" : "" ?>>
                            <label class="custom-control-label" for="Tidak_Tersedia_Kepsek">Tidak Tersedia</label>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div style="margin-top:6px;">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="Tersedia_Internet" name="Internet"
                                value="Tersedia" <?=($data['Internet']=="Tersedia" ) ? "checked" : "" ?>>
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="Tidak_Tersedia_Internet"
                                name="Internet" value="Tidak_Tersedia" <?=($data['Internet']=="Tidak Tersedia" )
                                ? "checked" : "" ?>>
                            <label class="custom-control-label" for="Tidak_Tersedia_Internet">Tidak Tersedia</label>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div style="margin-top:6px;">
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="Tersedia_Listrik" name="Listrik"
                                value="Tersedia" <?=($data['Listrik']=="Tersedia" ) ? "checked" : "" ?>>
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="Tidak_Tersedia_Listrik"
                                name="Listrik" value="Tidak Tersedia" <?=($data['Listrik']=="Tidak Tersedia" ) ? "checked"
                                : "" ?>>
                            <label class="custom-control-label" for="Tidak_Tersedia_Listrik">Tidak Tersedia</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div style="margin-top:6px;">
                        ...
                        <Input type="number" class="form-control" name="RK_Baik" value="<?= $data['RK_Baik'] ?>">
                        <br>
                        <label for="RK_Rusak">RK Rusak :</label>
                        <Input type="number" class="form-control" name="RK_Rusak" value="<?= $data['RK_Rusak'] ?>">
                    </div>
                </div>
            </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div style="margin-top:6px;">
                ...
                <Input type="number" class="form-control" name="RG_Baik" value="<?= $data['RG_Baik'] ?>">
                <br>
                <label for="RG_Rusak">RG Rusak :</label>
                <Input type="number" class="form-control" name="RG_Rusak" value="<?= $data['RG_Rusak'] ?>">
            </div>
        </div>
    </div>
    <br>
    <div class="row">
        <div class="col-md-12">
            ...
            <div style="margin-top:6px;">
                ...
                <Input type="number" class="form-control" name="TS_Baik" value="<?= $data['TS_Baik'] ?>">
                <br>
                <label for="TS_Rusak">TS Rusak :</label>
                <Input type="number" class="form-control" name="TS_Rusak" value="<?= $data['TS_Rusak'] ?>">
            </div>
        </div>
    </div>
    <br>
    <div class="row" style="margin-bottom:6px;">
        <div class="col-md-12">
            ...
            <div style="margin-top:6px;">
                ...
                <Input type="number" class="form-control" name="TG_Baik" value="<?= $data['TG_Baik'] ?>">
                <br>
                <label for="TG_Rusak">TG Rusak :</label>
                <Input type="number" class="form-control" name="TG_Rusak" value="<?= $data['TG_Rusak'] ?>">
            </div>
        </div>
    </div>
...
<script>
    ...
    $('[name="btn_simpan"]').on('click', function () {
        ...
        if (
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() ?>kelola_prasarana/edit",
                dataType: "json",
                data: {
                    id: "<?= base64_encode($this->encryption->encrypt($data['id_prasarana'])) ?>",
