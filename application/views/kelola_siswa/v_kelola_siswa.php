      	...
      	<script>
      		...
      		$(document).ready(function() {
      			...
      			datatable = $("#datatable").DataTable({
      				...
      				"columns": [{
      					...
      					{
      						data: 5,
      						name: 'tbl_siswa.alamat'
      					},
      					{
      						data: 6,
      						name: 'tbl_siswa.nama_ortu'
      					},
      					{
      						data: 7,
      						name: 'tbl_siswa.no_telp_ortu'
      					},
      					{
      						data: 8,
      						name: 'tbl_siswa.pekerjaan_ortu'
      					},
      					{
      						data: 9,
      						name: 'tbl_siswa.usia_adik'
      					},
      					{
      						data: 10,
      		...
      		$(document).on("click", ".modalButton", function() {
      			...
      			if (jenis == "tambah") {
      				...
      				$("#modal-content").load("<?= base_url('kelola_siswa/modalEdit') ?>", {
      					id: id
      				})
      			}
      		});
