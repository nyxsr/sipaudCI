      ...
      <div class="sidebar-wrapper ps-bar">
        ...
        <ul class="nav" id="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapsePendidikan"
              ...
              <div id="collapsePendidikan" class="collapse" aria-labelledby="headingPendidikan"
            ...
            <hr class="sidebar-divider" />
          <li class="nav-item">
            <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseKesehatan"
