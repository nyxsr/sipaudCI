...
class Kelola_Pengguna extends CI_Controller
{
			...
			$output['data'][] = array(
				...
				'<div class="row">
					<div class="col-md-6 text-center">
						<a href="javascript:void(0);" class="text-success modalButton"  data-toggle="modal" data-target="#modal" data-type="edit" data-id="' . base64_encode($this->encryption->encrypt($dt['iduser'])) . '"><i class="fa fas fa-pencil"></i></a>
					</div>
					<div class="col-md-6 text-center">
						<a href="javascript:void(0);" onclick="hapus(' . $dt['iduser'] . ');" class="text-danger"><i class="fa fas fa-trash"></i></a>
					</div>
				</div>',
	...
	public function modalEdit()
	{
		...
		$data['data'] = $this->M_Pengguna->getWhere(["tbl_users.id" => $this->encryption->decrypt(base64_decode($id))])->row_array();
	...
	public function delete()
	{
		...
		$id_lembaga		= isset($lembaga['id_lembaga']) ? $lembaga['id_lembaga'] : '';
		if ($id_lembaga != NULL) {
